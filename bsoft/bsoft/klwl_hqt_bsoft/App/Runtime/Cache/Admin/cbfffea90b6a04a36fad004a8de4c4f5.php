...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/dbkl_hqt_project/APP/Admin/View/Public/Css/public.css"/>
	<link rel="stylesheet" type="text/css" href="/dbkl_hqt_project/APP/Admin/View/Public/Css/node.css" />
	<script type="text/javascript" src="/dbkl_hqt_project/APP/Admin/View/Public/Js/back/jquery.min.js"></script>
...
<body>
	<form action="<?php echo U(MODULE_NAME.'/Rbac/setAccess');?>" method="post">
		<div id='wrap'>
			<a href="<?php echo U(MODULE_NAME.'/Rbac/role');?>" class="add-app">返回</a>
