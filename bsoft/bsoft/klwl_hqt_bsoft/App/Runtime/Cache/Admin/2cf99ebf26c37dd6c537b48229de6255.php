...
<div class="rightinfo">  
	<div class="tools">
		<ul class="seachform">
			...
			<li onclick="update(this)" src="<?php echo U(MODULE_NAME.'/Rbac/addUser');?>" class="toolbar"><span><img src="/klwl_hqt_bsoft/APP/Admin/View/Public/Images/t01.png" /></span>添加</li> 	            
		</ul>
	</div>    
</div>
			...
			<?php if($v["name"] == C("RBAC_SUPERADMIN")): ?><td>我超级，我牛逼</td>
				...
				<td class="caozuo">
					<li onclick="update(this)" src="<?php echo U(MODULE_NAME.'/Rbac/lock',array('pid'=> $v['id']));?>">
						<?php if($v['lock']): ?><img src="/klwl_hqt_bsoft/APP/Admin/View/Public/Images/lock.png"/>开启
						<?php else: ?>
							<img src="/klwl_hqt_bsoft/APP/Admin/View/Public/Images/unlock.png"/>锁定<?php endif; ?>
					</li>
					<li onclick="del(this)" src="<?php echo U(MODULE_NAME.'/Rbac/delete',array('del'=> $v['id']));?>"><img src="/klwl_hqt_bsoft/APP/Admin/View/Public/Images/close1.png"/>删除</li>
				</td><?php endif; ?>
