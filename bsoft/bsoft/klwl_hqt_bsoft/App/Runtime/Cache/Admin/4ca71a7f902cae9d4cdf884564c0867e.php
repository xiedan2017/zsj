...
<form action="<?php echo U(MODULE_NAME.'/Messages/deleteall');?>" method="post">
	<table class="tablelist">
		...
		<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
				...
				<?php if($v['status']==0): ?><td class="green"><img src="/klwl_hqt_bsoft/APP/Admin/View/Public/Images/dui.png" style="height: 23px;top: 4px;position: relative;"/><span>已处理</span></td>
				<?php else: ?>
					<td class="red"><img src="/klwl_hqt_bsoft/APP/Admin/View/Public/Images/cuo.png" data="<?php echo ($v["id"]); ?>" onclick="chuli(this)" style="height: 23px;top: 4px;position: relative;"/><span>未处理</span></td><?php endif; ?>
				<td><?php echo ($v["ip"]); ?></td>
				<td><?php echo (date("Y-m-d h:i:s",$v["time"])); ?></td>
				<td class="caozuo">
				    <?php if($v['status'] == 1): ?><li onclick="update(this)" src="<?php echo U(MODULE_NAME.'/Messages/copy',array('id'=>$v['id']));?>"><img src="/klwl_hqt_bsoft/APP/Admin/View/Public/Images/copy.png" title="回复" />回复</li><?php endif; ?>
					<li onclick="update(this)" src="<?php echo U(MODULE_NAME.'/Messages/search',array('id'=>$v['id']));?>"><img src="/klwl_hqt_bsoft/APP/Admin/View/Public/Images/search.png"/>查看</li>
					<li onclick="del(this)" src="<?php echo U(MODULE_NAME.'/Messages/delete',array('del'=>$v['id']));?>"><img src="/klwl_hqt_bsoft/APP/Admin/View/Public/Images/close1.png"/>删除</li>
				</td>
...
<script type="text/javascript">
	function chuli(obj) {
		$.ajax({
			...
			success:function(rs){
				if(rs==1){
					$(obj).attr('src','/klwl_hqt_bsoft/APP/Admin/View/Public/Images/dui.png');
