    ...
    <div class="zuo">
        ...
        <div class="dyzhengwen">
            <div class="dyzhengwenzuo">
                <!-- <div class="dylest">
                    <h3><a href="/a/xinwenzhongxin/2016/0728/116.html"><strong>热烈庆祝广州碧软与中国恒大续签下一年度软件外包业务</strong></a></h3>
                    <span>2016-08-08</span><br>
                        经过多年合作，广州碧软凭借自身灵活高效的软件外包管理流程及良好的服务精神，赢得客户中国恒大的赞许，...
                </div> -->
                <div class="lest">
                    <ul>
                        <?php if(is_array($newslist)): foreach($newslist as $key=>$v): ?><li><w style=" width:5px; height:5px; background:#F00; float:left; margin-right:10px; margin-top:10px;"></w><span><?php echo (date('Y-m-d',$v["time"])); ?></span><a href="<?php echo U(MODULE_NAME.'/News/details',array('newsid'=>$v['id']));?>"><?php echo (subtext($v["title"],25)); ?></a></li><?php endforeach; endif; ?>
                    </ul>
                </div>
                <div class="yeshu">
