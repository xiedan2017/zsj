...
<div class="barren">
    <img src="/klwl_hqt_bsoft/Public/images/barren.jpg" width="100%" />
</div>
    ...
    <div class="guanyuz">
        <div class="gyz">
            <div class="gyzt">
                ...
                <a href="<?php echo U(MODULE_NAME.'/Product/detail',array('cate'=>$service['cate'],'pid'=>$service['id']));?>"> <img src="/klwl_hqt_bsoft/Public/images/mo.png" width="37" height="12" /> </a>
            </div>
            <ul>
                <li>
                    <img src="/klwl_hqt_bsoft/Public/images/tu-1.jpg" width="35" height="35" />
                    <p>
                ...
                <li>
                    <img src="/klwl_hqt_bsoft/Public/images/tu-2.jpg" width="35" height="35" />
                    <p>
                ...
                <li>
                    <img src="/klwl_hqt_bsoft/Public/images/tu-3.jpg" width="35" height="35" />
                    <p>
                ...
                <li>
                    <img src="/klwl_hqt_bsoft/Public/images/tu-4.jpg" width="35" height="35" />
                    <p>
        ...
        <div class="gyzo">
            <div class="gyzt">
                ...
                <a href="<?php echo U(MODULE_NAME.'/News/index',array('cate'=>$news[0][cate]));?>"> <img src="/klwl_hqt_bsoft/Public/images/mo.png" width="37" height="12" /> </a>
            </div>
            <ul>
        ...
        <div class="gyy">
            ...
            <div class="tu">
                <img src="/klwl_hqt_bsoft/Public/images/lianxi.png" width="230" height="90" />
