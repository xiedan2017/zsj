...
<div class="rightinfo">  
	<div class="tools">
		<ul class="seachform">
			...
			<li onclick="update(this)" src="<?php echo U(MODULE_NAME.'/Product/edit');?>" class="toolbar"><span><img src="/bsoft/APP/Admin/View/Public/Images/t01.png" /></span>添加</li>
		</ul>
	</div>    
</div>
<form action="<?php echo U(MODULE_NAME.'/Product/deleteall');?>" method="post">
	<table class="tablelist">
		...
		<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
				...
				<td class="caozuo">
					<li onclick="update(this)" src="<?php echo U(MODULE_NAME.'/Product/edit',array('id'=>$v['id']));?>"><img src="/bsoft/APP/Admin/View/Public/Images/t02.png"/>修改</li>
					<li onclick="del(this)" src="<?php echo U(MODULE_NAME.'/Product/delete',array('del'=>$v['id']));?>"><img src="/bsoft/APP/Admin/View/Public/Images/close1.png"/>删除</li>
				</td>
