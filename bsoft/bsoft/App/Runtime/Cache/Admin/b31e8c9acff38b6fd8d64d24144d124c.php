...
<style type="text/css">
	 .avatar_uplpad_btn {
	    background:  url("/bsoft/APP/Admin/View/Public/Images/avatar_uplpad_btn.png") no-repeat scroll 0 0;
				...
				<div class="avatar_area">
		            ...
		            <div id="avatar_pic">
		                <a  target="_blank" href="<?php echo ($data["pic"]); ?>">
		                    <img alt="图片" src="<?php echo ((isset($data["pic"]) && ($data["pic"] !== ""))?($data["pic"]):'/bsoft/APP/Admin/View/Public/Images/addpic.png'); ?>" style="height: 100px;float: left; margin:10px" class="delpic" />
		                </a>
		            </div>
...
<script type="text/javascript" src="/bsoft/APP/Admin/View/Public/Js/plupload/plupload.full.min.js"></script>
