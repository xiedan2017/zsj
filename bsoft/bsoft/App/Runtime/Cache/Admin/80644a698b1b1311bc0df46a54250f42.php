...
<div class="rightinfo">  
	<div class="tools">
		<ul class="seachform">
			...
			<li onclick="update(this)" src="<?php echo U(MODULE_NAME.'/SendEmail/edit');?>" class="toolbar"><span><img src="/bsoft/APP/Admin/View/Public/Images/t01.png" /></span>发邮件</li> 	            
		</ul>
	</div>    
</div>
<table class="tablelist">
	...
	<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr style="white-space: nowrap;text-overflow: ellipsis;overflow: hidden;">
			...
			<td class="caozuo">
			    <li onclick="update(this)" src="<?php echo U(MODULE_NAME.'/SendEmail/search',array('id'=>$v['id']));?>"><img src="/bsoft/APP/Admin/View/Public/Images/search.png"/>查看详情</li>
			    <li onclick="del(this)" src="<?php echo U(MODULE_NAME.'/SendEmail/delete',array('del'=>$v['id']));?>"><img src="/bsoft/APP/Admin/View/Public/Images/close1.png"/>删除</li>
			</td>
