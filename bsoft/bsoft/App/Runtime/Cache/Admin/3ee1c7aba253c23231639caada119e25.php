...
<div class="rightinfo">  
	<div class="tools">
		<ul class="seachform"> 
			...
			<li onclick="update(this)" src="<?php echo U(MODULE_NAME.'/Rbac/addRole');?>" class="toolbar"><span><img src="/bsoft/APP/Admin/View/Public/Images/t01.png" /></span>添加</li>          
		</ul>
	</div>    
</div>
<table class="tablelist">
	...
	<?php if(is_array($role)): foreach($role as $key=>$v): ?><tr>
			...
			<td class="caozuo">
				<li onclick="update(this)" src="<?php echo U(MODULE_NAME.'/Rbac/access',array('rid'=>$v['id']));?>" style="width:88px"><img src="/bsoft/APP/Admin/View/Public/Images/peizhi.jpg"/>配置权限</li>
				<li onclick="del(this)" src="<?php echo U(MODULE_NAME.'/Rbac/delRole',array('del'=>$v['id']));?>"><img src="/bsoft/APP/Admin/View/Public/Images/close1.png"/>删除</li>
			</td>
