...
<div class="rightinfo">
	<div class="tools">
		<ul class="seachform">   
			...
			<li onclick="update(this)" src="<?php echo U(MODULE_NAME.'/Menu/edit');?>" class="toolbar"><span><img src="/bsoft/APP/Admin/View/Public/Images/t01.png" /></span>添加</li>
			<li class="toolbar"  onclick="Delete()"><span><img src="/bsoft/APP/Admin/View/Public/Images/t03.png" /></span>删除</li>		            
		</ul>
	</div>    
</div>
<form action="<?php echo U(MODULE_NAME.'/Menu/deleteall');?>" name="form1" method="post">
	<table class="tablelist">   
		...
		<?php if(is_array($menu)): foreach($menu as $key=>$v): ?><tr>
				...
				<td class="caozuo">
					<?php if($v['level'] == 1): ?><li onclick="update(this)" src="<?php echo U(MODULE_NAME.'/Menu/edit',array('id'=>$v['id']));?>" style="width: 96px"><img src="/bsoft/APP/Admin/View/Public/Images/t01.png" />添加子菜单</li><?php endif; ?>
					<li onclick="update(this)" src="<?php echo U(MODULE_NAME.'/Menu/edit',array('upid'=>$v['id']));?>"><img src="/bsoft/APP/Admin/View/Public/Images/t02.png"/>修改</li>
					<li onclick="del(this)" src="<?php echo U(MODULE_NAME.'/Menu/del',array('id'=>$v['id']));?>"><img src="/bsoft/APP/Admin/View/Public/Images/close1.png"/>删除</li>
				</td>
