...
<body>
    ...
    <div class="mainindex"> 
        <div class="welinfo">
            <span><img src="/bsoft/APP/Admin/View/Public/Images/sun.png" alt="天气" /></span>
            <b><strong style="font-size:20px; color:red"><?php echo ($msg["name"]); ?></strong> 您好，欢迎进入<?php echo ($company); ?>  后台管理系统</b>
        </div>
        <div class="welinfo">
            <span><img src="/bsoft/APP/Admin/View/Public/Images/time.png" alt="时间" /></span>
   ...
   <!-- 修改公司LOGO -->
        <div class="welinfo">
            <span><img src="/bsoft/APP/Admin/View/Public/Images/t05.png" alt="LOGO" /></span>
        ...
        <form action="<?php echo U(MODULE_NAME.'/Index/setlogo');?>" method ="post" enctype="multipart/form-data">
            <div class="welinfo" style="height: 120px;">
              <span><img src="/bsoft/APP/Admin/View/Public/Images/t02.png" alt="logo" />网站LOGO</span>
              <i><img src="/bsoft/<?php echo ($logo['pic']); ?>" alt="网站logo" style="height: 105px; width: 231px;" />&nbsp;&nbsp;<label>尺寸: 231px* 72px</label>&nbsp;&nbsp;<input name="picname" type="file" class="dfinput" style="text-indent: 2px; width:250px"/></i> 
    ...
    <!-- 后台使用指南 -->
        ...
        <div class="box"></div>
        <div class="welinfo">
            <span><img src="/bsoft/APP/Admin/View/Public/Images/dp.png" alt="提醒" /></span>
