...
<div class="atcker">
    ...
    <div class="zuo">
        <div class="tu"> <img src="<?php echo ((isset($productcate["pic"]) && ($productcate["pic"] !== ""))?($productcate["pic"]):'/bsoft/Public/images/1-151125114634439.jpg'); ?>" width="926" height="170"/> </div>
        <div class="dyzhengwen">
            <div class="dyzhengwenzuo">
                <div class="dingwei">
                    <w class="p"> <?php echo ($detail["name"]); ?> </w>
                    <br />
                    <div>
